...
let s:N1 = [ '#ffffff' , '#000000' , 231  , 36 ]
let s:N2 = [ '#ffffff' , '#003f3f' , 231 , 23 ]
let s:N3 = [ '#ffffff' , '#002b2b' , 231  , 236 ]
...
let g:airline#themes#minimal_dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#450000' , 231     , 236      , ''     ] ,
      \ }


let s:I1 = [ '#ffffff' , '#87afd7' , 231 , 0 ]
...
let g:airline#themes#minimal_dark#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#005e5e' , 255     , 236      , ''     ] ,
      \ }
...
let g:airline#themes#minimal_dark#palette.tabline = {
      ...
      \ 'airline_tabsel':  ['#ffffff', '#2e8b57',  232, 123, ''],
      \ 'airline_tabtype':  ['#ffffff', '#000000',  231, 36, ''],
      \ 'airline_tabfill':  ['#ffffff', '#002b2b',  231, 236, ''],
      \ 'airline_tabmod':  ['#ffffff', '#780000',  231, 0, ''],
      \ }

let s:WI = [ '#ffffff', '#5f0000', 231, 236 ]
...
let g:airline#themes#minimal_dark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      ...
      \ [ '#ffffff' , '#000000' , 231 , 36 , ''     ] ,
      \ [ '#ffffff' , '#973d45' , 231 , 232 , ''     ] )
