...
let s:N1 = [ '#ffffff' , '#00136136' , 231  , 36 ]
...
let g:airline#themes#minimal_dark#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#450000' , 231     , 136      , ''     ] ,
      \ }


let s:I1 = [ '#ffffff' , '#87afd7' , 231 , 110 ]
...
let g:airline#themes#minimal_dark#palette.tabline = {
      ...
      \ 'airline_tabtype':  ['#ffffff', '#00136136',  231, 36, ''],
      \ 'airline_tabfill':  ['#ffffff', '#002b2b',  231, 23, ''],
      \ 'airline_tabmod':  ['#ffffff', '#780000',  231, 136, ''],
      \ }

let s:WI = [ '#ffffff', '#5f0000', 231, 136 ]
